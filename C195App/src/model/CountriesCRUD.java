...
public class CountriesCRUD {
    ...
    public static void select() throws Exception {
        ...
        PreparedStatement ps = JDBC.c.prepareStatement("SELECT * FROM countries");
        //DBQuery.setStatement(JDBC.c, "SELECT * FROM USERS");
        ResultSet rs = ps.executeQuery();
        while (rs.next()) {
            //System.out.println(rs.getInt(1));
            //System.out.println(rs.getString(2) + " " + rs.getString(3));
            Country country = new Country(rs.getInt(1),rs.getString(2),rs.getDate(3),rs.getString(4),rs.getTimestamp(5),rs.getString(6));
            DataProvider.addCountry(country);
            //System.out.println(DataProvider.getAllCountries());
        }
    }
/*
