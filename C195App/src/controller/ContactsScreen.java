...
public class ContactsScreen implements Initializable {

    public TableView contactsApptTable;
    ...
    /**
     * This method sends the user back to the Reports Screen.
     * @param actionEvent
     * @throws Exception
     */
    ...
    public void refreshTable() throws Exception {
        ...
        apptList.setAll(DataProvider.getContactAppointments());
        contactsApptTable.setItems(apptList);
    }
}
